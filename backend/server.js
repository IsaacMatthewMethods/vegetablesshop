...
app.post('/api/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUsers, hashedPassword, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, createUsersTable()];
            case 1:
                _b.sent();
            ...
            case 4:
                ...
                return [4 /*yield*/, pool.query('INSERT INTO users (email, password) VALUES (?, ?)', [email, hashedPassword])];
            case 5:
                _b.sent();
...
app.post('/api/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, users, user, isPasswordValid, token, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, createUsersTable()];
            case 1:
            ...
            case 4:
                ...
                token = jsonwebtoken_1.default.sign({ userId: user.id }, 'e1a8e7f1-1b3a-4b0e-8b0a-9b0c1d9e0f1a', { expiresIn: '1h' });
